// memory related prompt modules

pub const SUMMARY_FORMAT: &str = r#"# Conversation Summary
...
pub const SUMMARY_PROMPT: &str = r#"You are a conversation summarizer. Summarize the following conversation history into a structured format.
...
pub const COMPRESS_SUMMARY_PROMPT: &str = r#"You are a summary compressor. The current summary is too long and needs to be compressed to fit within {target_tokens} tokens.
