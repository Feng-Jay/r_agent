...
pub const REACT_END_TOKEN: &str = "<|end_of_react|>";

pub const REACT_SYSTEM_PROMPT_TEMPLATE: &str = r#"You are an AI assistant that follows the ReAct (Reasoning and Acting) paradigm.
...
pub static REACT_SYSTEM_PROMPT: Lazy<String> = Lazy::new(|| {
    REACT_SYSTEM_PROMPT_TEMPLATE.replace("{REACT_END_TOKEN}", REACT_END_TOKEN)
});